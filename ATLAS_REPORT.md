...
The Interloper image orientation is updated each frame so its front points toward the Sun. The procedural comet visual follows the same anti-solar frame, keeping its darker shading away from the Sun.
