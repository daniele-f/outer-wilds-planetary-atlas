...
export const celestialBodies: readonly CelestialBody[] = [
  ...
  {
    id: 'orbital-probe-cannon', name: 'Orbital Probe Cannon', classification: 'Probe launcher', type: 'Giant’s Deep satellite',
    tagline: 'Go for the launch spectacle, stay for the one-way ticket.',
    pitch: 'A single, rugged launcher-and-probe assembly circles Giant’s Deep, turning orbital engineering into a dramatic piece of scenery.',
    attractions: ['A complete attached probe assembly', 'A front-row view of the ocean giant'],
    travelTips: ['Watch the launch vector.', 'Keep clear of the rotating frame.'],
    satelliteIds: [], orbit: orbit(45, 22, 0.8, { direction: 1 }),
  },
  {
